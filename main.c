...
*/
				...
				else
				{
					...
					if(FindCard(HandCardt[i],"JAIL") != -1){
				...
				//		}
					...
					if(FindCard(HandCard[i],"DUEL") != -1 && countCardName(HandCard[i],"BANG") >= 3){
						ard_id = FindCard(HandCard[i],"DUEL");
					}
					if(board[i] != character[i].hp && card_id != 0){
